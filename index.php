        ...
        <header class = "header bg-bright" id = "header">
            <div class = "container">
                <div class = "header-content text-center">
                    ...
                    <a href = "login.php" class = "btn btn-primary text-uppercase">create my resume</a>
            ...
            <div class="container">
                <div class = "section-one-content">
                    ...
                    <div class = "section-one-r text-center">
                        ...
                        <div class = "btn-group">
                            <a href = "resume.php" class = "btn btn-primary text-uppercase">create my resume</a>
        ...
        <footer class = "footer bg-dark">
            <div class="container">
                <div class = "footer-content text-center">
                    <p class="fs-15">&copy;Copyright 2022. All Rights Reserved - <span>Resume Builder</span></p>
                </div>
            </div>
        </footer>
