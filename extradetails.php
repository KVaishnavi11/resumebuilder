...
<body>
    ...
    <?php
                ...
                if (count($errors) > 0) {
                    ...
                    if (mysqli_num_rows($checkResult) > 0) {
                        ...
                        if (mysqli_stmt_prepare($updateStmt, $updateQuery)) {
                            mysqli_stmt_bind_param($updateStmt, "ssssssssssi", $skill1, $skill2, $skill3, $skill4, $skill6, $interest1, $interest2, $interest3, $interest4, $interest5,$interest6, $userId);
        ...
        <form action="">
            ...
            <div class="input-box">
                <div class="col-50">
                    <input type="text" placeholder="Skill 1" required>
                </div>
                <div class="col-50">
                    <input type="text" placeholder="Skill 2" required>
                </div>
                <div class="col-50">
                    <input type="text" placeholder="Skill 3" required>
                </div>
            </div>

            <div class="input-box">
                <div class="col-50">
                    <input type="text" placeholder="Skill 4" required>
                </div>
                <div class="col-50">
                    <input type="text" placeholder="Skill 5" required>
                </div>
                <div class="col-50">
                    <input type="text" placeholder="Skill 6" required>
                </div>
            </div>
            ...
            <button class="button2" type="Submit">Next</button>
            </div>
